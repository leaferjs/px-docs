...
### 基础 &nbsp; &nbsp; [高级](/plugin/official/clipper/config/advanced.md)
...
裁剪控制点高度比例（相对 pointSize）, 默认为 0.3。
...
### horizontalLine?: `boolean` | `IClipEditorHorizontalLineConfig`
...
```ts
interface IClipEditorHorizontalLineConfig {
